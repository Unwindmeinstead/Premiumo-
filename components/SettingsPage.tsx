  ...
  return (
    <div>
      ...
      <select
        ...
        className="mt-1 w-full bg-dark-surface border border-dark-border rounded-lg px-3 py-2 text-sm md:text-base text-white focus:outline-none focus:ring-2 focus:ring-white/40"
      >
        {options.map((o) => (
...
export default function SettingsPage() {
  ...
  return (
    <div className="w-full max-w-2xl sm:max-w-3xl md:max-w-4xl lg:max-w-5xl mx-auto px-0 sm:px-1 space-y-4 sm:space-y-5 md:space-y-6 pb-24 sm:pb-28 md:pb-32 lg:pb-36">
      <div>
        <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-1">Settings</h1>
        ...
        <div className="space-y-4 sm:space-y-5 md:space-y-6">
          ...
          <section className={cardBase}>
            <div className="flex items-center gap-2 mb-3 md:mb-4">
              ...
              <h2 className="text-sm sm:text-base font-semibold text-white">Display</h2>
            </div>
          ...
          <section className={cardBase}>
            <div className="flex items-center gap-2 mb-3 md:mb-4">
              ...
              <h2 className="text-sm sm:text-base font-semibold text-white">Dashboard defaults</h2>
            </div>
            <div className="space-y-3 md:space-y-4">
          ...
          <section className={cardBase}>
            <div className="flex items-center gap-2 mb-3 md:mb-4">
              ...
              <h2 className="text-sm sm:text-base font-semibold text-white">Metrics</h2>
            </div>
            <Toggle
        ...
        <div className="space-y-4 sm:space-y-5 md:space-y-6">
          ...
          <section className={cardBase}>
            <div className="flex items-center gap-2 mb-2 md:mb-3">
              ...
              <h2 className="text-sm sm:text-base font-semibold text-white">Backup</h2>
            </div>
            <p className="text-xs sm:text-sm md:text-base text-dark-muted leading-relaxed mb-2">
          ...
          <section className={cardBase}>
            <div className="flex items-center gap-2 mb-2 md:mb-3">
              ...
              <h2 className="text-sm sm:text-base font-semibold text-white">About</h2>
            </div>
            <p className="text-xs sm:text-sm md:text-base text-dark-muted leading-relaxed">
